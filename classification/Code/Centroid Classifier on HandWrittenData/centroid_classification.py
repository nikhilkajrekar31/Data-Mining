...
class dataHandler(object):
    ...
    def main(self,frm,to):
        ...
        dataSet=dataHandle.pickDataClass('HandWrittenLetters.txt',dataHandle.letter_2_digit_convert('DEFGHIJKLM'))
...
finalClassifiedList=[]
finalAccuracyList=[]
for i in range(4,39,5):
    classifiedList,accuracy = dataHand.main(i,39)
